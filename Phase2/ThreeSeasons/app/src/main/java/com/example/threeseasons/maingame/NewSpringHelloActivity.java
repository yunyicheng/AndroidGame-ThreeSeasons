...
public class NewSpringHelloActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_spring_hello);
    }

    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.next_hello:
